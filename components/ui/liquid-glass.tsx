...
interface LiquidGlassProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  onLiquidDragStart?: () => void
  onLiquidDragEnd?: () => void
}
...
export function LiquidGlass({
  ...
  const handleMouseDown = useCallback(
    ...
    [stretchOnDrag, onLiquidDragStart, createRipple, variant],
  )
  ...
  }, [isDragging, dragOffset, onLiquidDragEnd, variant, isPressed])
  ...
  const handleTouchStart = useCallback(
    ...
    [stretchOnDrag, onLiquidDragStart, rippleEffect, variant],
  )
